...
import com.idoc.api.ApiContorller;
...
public class ZipUtils {
	private static final Logger LOG = LoggerFactory.getLogger(ApiContorller.class) ;
	
	public static void main(String[] args) throws IOException {	    
		List<String> listname = Lists.newArrayList() ;
		String zipdir = "E:/ly/jsuan" ; //"C:/Users/liyang/Desktop/2017" ;//"E:/ly/jsuan" ;
		String unzipdir =  "E:/ly/unzipjsuan";// "C:/Users/liyang/Desktop/2017unzip2" ;// "E:/ly/unzipjsuan" ;
		readAllFile(zipdir, listname); 
	...
	public static void readAllFile(String filepath , List<String> listname){  
        ...
        if(! file.isDirectory()){  
            ...
            for(String fileName : filelist){  
                readAllFile(filepath + File.separator + fileName , listname);//递归  
            }  
        }  
	 }
			...
			try {
				...
				while ((archiveEntry = zais.getNextEntry()) != null) { 
					...
					try {
						...
						LOG.info("had unzip : " + entryFilePath) ;
